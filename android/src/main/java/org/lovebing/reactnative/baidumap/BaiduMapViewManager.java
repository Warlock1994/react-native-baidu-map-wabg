...
public class BaiduMapViewManager extends ViewGroupManager<MapView> {
    ...
    public void setMarker(MapView mapView, ReadableMap option) {
        if(option != null && option.hasKey("latitude") && option.hasKey("longitude")) {
...
//        }
    ...
    private void setListeners(final MapView mapView) {
        ...
        if(mMarkerText == null) {
            ...
            mMarkerText.setBackgroundResource(R.drawable.pop);
...
//                textView.setPadding(32,32,32,32);
                ...
                InfoWindow infoWindow = new InfoWindow(descriptor, marker.getPosition(), -150, new InfoWindow.OnInfoWindowClickListener() {
                    @Override
                    public void onInfoWindowClick() {
                        ...
                        if(bundle != null ){
                            if(bundle.containsKey("mark"))  writableMap.putString("mark",bundle.getString("mark"));
                            if(bundle.containsKey("goods_type"))  writableMap.putInt("goods_type",bundle.getInt("goods_type"));
                            if(bundle.containsKey("goods_id"))  writableMap.putInt("goods_id",bundle.getInt("goods_id"));
                            if(bundle.containsKey("uid"))  writableMap.putInt("uid",bundle.getInt("uid"));
                        }

                        sendEvent(mapView, "onPopClick", writableMap);
                    }
                });
